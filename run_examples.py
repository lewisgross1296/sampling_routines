...
N = 5
CONSTANT_NORMALIZED_BIN_VALS = pdft.createNormalizedPDF(
...
# number of energy grid points
N = 5
LINEAR_NORMALIZED_BIN_VALS = pdft.createNormalizedPDF(
    E_GRID, BIN_VALS, N, "linear")
print("original bin vals:", BIN_VALS,
...
FAILED_NORMALIZED_BIN_VALS = pdft.createNormalizedPDF(
    E_GRID, BIN_VALS, N, "YOLO")
print("original bin vals:", BIN_VALS,
